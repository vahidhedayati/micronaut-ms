...
const StockTable = ({stocks,customerName,logout, amount, updateAmount,buy,active,currentBill}) => <div>
...
{stocks.map(v => <StockRow  key={v.name} stock={v} customerName={customerName}  amount={amount} updateAmount={updateAmount} buy={buy} active={active} />)}
